...
1. [Playbook startup][playbook-startup] — canonical startup route.
2. [`AGENTS.md`](AGENTS.md) — repository execution layer.
3. [Claude adapter][claude-adapter] — executor-specific guidance.
...
[playbook-startup]:
  https://github.com/ctrl-alt-keith/ai-workflow-playbook/blob/main/docs/start-here.md
[claude-adapter]:
  https://github.com/ctrl-alt-keith/ai-workflow-playbook/blob/main/docs/tool-adapters/claude.md
